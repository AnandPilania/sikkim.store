<x-layout.home title="Home">
    <section class="bg-no-repeat bg-auto md:bg-auto bg-top"
        ...
        <div
            ...
            <!--Hero Title-->
            <div class="w-full md:max-w-2xl mt-32 sm:mt-0">
                ...
                <div class="mt-6 md:mt-8" data-aos="zoom-in" data-aos-delay="500">
                    <a href="{{ route('seller.register') }}"
                       class="block w-full md:w-64 btn btn-success px-5 py-3 text-sm uppercase">
            ...
            <div data-aos="zoom-in" data-aos-duration="1000" class="hidden lg:block max-w-md">
                <img loading="lazy" height="100%" width="100%" src="{{ asset('assets/images/hero_bg.svg') }}" alt="Hero Image" class="w-full h-full object-cover">
            </div>

        </div>
    </section>

    <section class="relative py-24 bg-gradient-to-b from-white to-emerald-500 ">
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">

            <div class="lg:text-center">
                <p class="text-base leading-6 bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-500 to-purple-600 font-semibold tracking-wide uppercase">
                    Sikkim Store</p>
            ...
            <div
                class="mt-20 md:mt-32 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-12 sm:gap-x-8 md:gap-x-12 md:gap-y-16">

                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-br from-cyan-400 to-light-blue-500 text-white shadow">
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-br from-fuchsia-500 to-purple-600 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-br from-orange-400 to-pink-600 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-br from-green-400 to-cyan-500  text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-br from-purple-500 to-indigo-500 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-tr from-yellow-400 to-orange-500 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-tr from-light-blue-400 to-indigo-500 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative shadow px-8 pt-12 pb-8 rounded-md bg-gray-50">
                    <div class="absolute top-0 transform -translate-y-1/2 flex-shrink-0">
                        <div
                            class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-tr from-pink-500 to-rose-500 text-white shadow">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section class="py-24 hero-pattern-diamond">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 md:mt-8">
                <a a href="{{ route('seller.register') }}"
                   class="mx-auto block w-full md:w-64 px-5 py-3 btn btn-success text-sm uppercase">
                    Register Now.
                </a>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="bg-green-700">
            <div class="max-w-6xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between flex-wrap">
                    ...
                    <div class="order-2 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                        <a href="#"
                           class="flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-green-700 bg-gray-100 hover:bg-green-50 transform btn-scale transition ease-in-out">
                            Support
                        </a>
                    </div>
                </div>
