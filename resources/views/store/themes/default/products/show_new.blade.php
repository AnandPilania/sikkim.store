<x-layout.store title="{{ $store->name }}">
        ...
        <div class="max-w-5xl mx-auto px-5 py-5 md:pt-24 md:pb-12 lg:px-0">
            <div class="mx-auto flex flex-wrap">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full md:w-112">
                        <div class="w-full h-auto md:h-112 rounded-md overflow-hidden">
                            <img alt="ecommerce" class="w-full h-full object-cover" src="{{ $product->featured_image }}">
                        </div>
                        <div class="w-full mt-2 flex items-center justify-start space-x-2">
                            <div class="w-16 h-16 ring-1 ring-gray-300 overflow-hidden rounded-md">
                                <img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" alt="">
                            </div>
                            <div class="w-16 h-16 ring-1 ring-gray-300 overflow-hidden rounded-md">
                                <img src="https://images.unsplash.com/photo-1518894781321-630e638d0742?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=3400&q=80" alt="">
                            </div>
                            <div class="w-16 h-16 ring-1 ring-gray-300 overflow-hidden rounded-md">
                                <img src="https://images.unsplash.com/photo-1605034313761-73ea4a0cfbf3?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" alt="">
                            </div>
                            <div class="w-16 h-16 ring-1 ring-gray-300 overflow-hidden rounded-md">
                                <img src="https://images.unsplash.com/photo-1605034313761-73ea4a0cfbf3?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" alt="">
                            </div>
                    ...
                    <div class="w-full md:flex-1 md:pl-10 mt-6 md:mt-0">

                        <h2 class="mb-2 text-sm title-font text-gray-500 tracking-widest uppercase">{{ $product->category_name }}</h2>
                        ...
                        <div class="flex mb-4">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-500 text-sm ml-3">4 Reviews</div>
                            </div>

                            <div class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
                                <a class="text-gray-500 p-2 bg-yellow-100 rounded-md">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
                                </a>
                                <a class="ml-2 text-gray-500 p-2 bg-yellow-100 rounded-md">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                        ...
                        <div class="mt-6 pb-5 md:mb-5">
                            ...
                            <div class="flex items-center mb-8">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute right-0 top-0 h-full w-10 text-center text-gray-600 pointer-events-none flex items-center justify-center">
                            ...
                            <div>
                                <p class="font-semibold text-2xl text-gray-800 font-sans tabular-nums">{{ $product->price }}</p>
                                <p class="text-sm text-gray-400 tabular-nums">
                                    Original price: {{ $product->price }}
                                    <span class="text-green-600 text-xs font-medium">(32% Off)</span>
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center justify-between space-x-2">
                            <button class="w-full text-yellow-800 font-medium bg-yellow-300 ring-2 ring-yellow-300 py-2.5 px-6 focus:outline-none hover:bg-yellow-400 rounded">
                                Buy Now
                            </button>
                            <button class="w-full text-yellow-500 ring-2 ring-2 ring-yellow-300 py-2.5 px-6 focus:outline-none hover:bg-yellow-200 hover:text-yellow-800 rounded">
                                Add to Cart
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-8 md:mt-12 prose">
                    <h3 class="text-lg font-semibold mb-2 text-gray-800">Product Details:</h3>
        ...
        <div class="max-w-5xl mx-auto px-5 lg:px-0 py-5">
            ...
            <div class="mb-4 md:mb-8 px-2 md:px-0">
                <div class="flex flex-col md:flex-row md:items-center mb-2">
                    <div class="px-2 w-max mb-1 md:mb-0 mr-4 py-0.5 bg-green-700 rounded-md text-white text-xs font-semibold inline-flex items-center w-max-content">
                        4.5
            ...
            <div class="w-20 mx-auto bg-yellow-100 h-1 rounded-full my-8 md:my-12"></div>
            <div class="mb-4 md:mb-8 px-2 md:px-0">
                <div class="flex flex-col md:flex-row md:items-center mb-2">
                    <div
                        class="px-2 w-max mb-1 md:mb-0 mr-4 py-0.5 bg-green-700 rounded-md text-white text-xs font-semibold inline-flex items-center w-max-content">
                        4.5
                        <svg class="w-3 h-3 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                             fill="currentColor">
                            <path
    ...
    <footer class="body-font bg-yellow-300">
        <div class="container max-w-5xl mx-auto pt-14 pb-8">
            ...
            <div
                class="flex items-center lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto mb-4">
