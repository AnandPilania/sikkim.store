    ...
    return (
        <div className="flex items-center justify-center lg:justify-between">
            <div className="w-full md:max-w-2xl mt-32 sm:mt-0">
                ...
                <p className="text-xs text-gray-500 mt-6 md:mt-8">Reserve your store name before someone takes it.</p>

                <div className="mt-2">
                    <InertiaLink href={''} className="block w-full md:w-64 btn btn-success px-5 py-3">
                        Get Started
                    </InertiaLink>
                </div>
