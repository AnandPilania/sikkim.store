                        ...
                        <div className="flex-1 flex-col mb-2 md:text-right">
                            ...
                            <div
                                ...
                                <a className="bg-gray-700 hover:bg-gray-200 p-1.5 rounded-md transition ease-in-out duration-200"
                                   ...
                                   rel="noreferrer">
                                    <svg
                                        className="w-5 h-5 transform hover:scale-110 transition ease-in-out duration-150"
                            ...
                            <div
                                className="text-xs font-medium tracking-normal text-gray-300 flex md:justify-end items-center space-x-2 mb-4">

                                <svg viewBox="0 0 160 100" className="h-7 text-green-500">
                                ...
                                <svg viewBox="0 0 64 64" fill="currentColor" className="h-9 text-green-500">
                                    <g id="Layer_2">
                                        <path
                                ...
                                <div className="italic text-green-500 font-bold font-titleFont tracking-widest">COD
                                </div>
                            </div>
                        </div>
                    </div>
